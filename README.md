...
παρατηρούνται για τους ρεμπέτες οικονομική αδυναμία και κακή σχέση με τις αστυνομικές αρχές λόγω παρανομίας. Η ιστορία συνεχίζεται με πόλεμο, κατοχή, 
...
κάτι που δεν άφησε ανεπηρέαστα τα τραγούδια τους, τα οποία χρησιμοποιήθηκαν είτε ως αντίσταση με το επαναστατικό τους περιεχόμενο, είτε ώστε να παρέχουν παρηγοριά και δύναμη.
...
τα όργανα της ορχήστρας, τους τρόπους σύνθεσης που χρησιμοποιούσαν οι συνθέτες του, τα μακάμ /δρόμους αλλά και τα περαιτέρω χαρακτηριστικά που σχετίζονται με τα παραπάνω.
...
Η δεύτερη περίοδος (1932-1943) είναι αυτή των μπουζουκομπαγλαμάδων, γνωστή και ως κλασική περίοδος του ρεμπέτικου είδους, όπου το τραγούδι αποκτά αυτονομία 
...
Αρχίζει να μεταμορφώνεται σε αρχοντορεμπέτικο τραγούδι καθώς βγαίνει από τους τεκέδες, και εισχωρεί σε κέντρα διασκέδασης, όρος που σύμφωνα με τον Στάθη Gauntlett χρησιμοποιείται 
...
Κατά την πρώτη περίοδο εμφανίζονται ασυγκέραστα όργανα (βιολί, λαούτο, σαντούρι, κλαρίνο, ούτι, ταμπουράς, κιθάρα ταραμπούκα, καθώς επίσης πλαισιωνόταν από φωνή
...
Όσον αφορά το ρυθμό και τα χορευτικά είδη, όλα είναι συνδεδεμένα με το παρελθόν. Συγκεκριμένα πατάνε σε ρυθμούς όπως ζεϊμπέκικος, σέρβικο, καρσιλαμάς, τσιφτετέλι 
αλλά και σε άλλους ρυθμούς του Ελλαδικού χώρου.

Επίσης, το παίξιμο και το τραγούδισμα στολίζει ένας πλούτος από γυρίσματα και τσακίσματα.
...
με έντονο το αίσθημα της χαρμολύπης λόγω των συνθηκών διαβίωσης. Βασικοί του εκφραστές ο Μ.Βαμβακάρης, ο Α.Δελιάς, ο Σ.Παγιουμτζής, ο Γ.Μπάτης, ο Σ.Περπινιάδης και άλλοι πολλοί. 
...
Το ταξίμι και ο αμανές χρησιμοποιούνται σπανιότερα μέσα στα τραγούδια.
...
ενώ προστίθενται νέα όργανα όπως το φλάουτο, το σαξόφωνο, τα κρουστά και το μπάσο.
...
πολλά πράγματα στην πορεία έχουν χαθεί. Στους στίχους φλαμένκο υπάρχει ένα ίχνος εξέγερσης, το αποτέλεσμα από τις διώξεις και την περιθωριοποίηση.
...
Τα τραγούδια των ανθρακορύχων κατήγγειλαν πάντα την εργατική εκμετάλλευση στους λάκκους.
...
Αυτές οι ερμηνείες, παράλληλα υποδηλώνουν και την πρόσμειξη πολιτισμών που φανερώνεται μέσα από τους ίδιους τους όρους, μουσουλμάνων με χριστιανούς και στις δύο περιπτώσεις,
...
**3.3**  **Λογοκρισία, Περιθωριοποίηση και ίχνος εξέγερσης**
...
ή και με την επαναστατική χροιά προς την άρχουσα τάξη, και άλλα, πέρασε από λογοκρισία επί δικτατορίας στην Ελλάδα.
...
στις αρχές του 17ου αιώνα, παρέμειναν στη χώρα, παραιτούμενοι ή κρυμμένοι, δεδομένου ότι, μεταξύ άλλων, ήταν οι κύριοι υπεύθυνοι για την καλλιέργεια των εδαφών στην Ανδαλουσία. Για το λόγο αυτό, υπάρχει η θεωρία γύρω από τη σχέση μεταξύ τσιγγάνων και μουσουλμάνων που, ενωμένοι στην περιθωριοποίησή τους, δημιουργούν δεσμούς και αναμειγνύουν πολιτισμούς, θέτοντας τα θεμέλια για τη γέννηση του φλαμένκο.
...
θεωρούν ότι δεν έχουν όλοι επαρκή γνώση και τεχνική, με αποτέλεσμα να έχουν οδηγήσει στη θεώρηση που πολλοί έχουν για το φλαμένκο, δηλαδή ως "φολκλορικό θέαμα".
...
η Ισπανία προς τα έξω, έρχεται από μακριά. Οι ρόλοι εξετάζονται κοιτάζοντας τη λαϊκή κουλτούρα στην Ισπανία του Φράνκο, όπου ο δικτάτορας απεικόνησε την κοινότητα των Ρομά
σε ένα στερεότυπο, αρνητικό και εξευτελιστικό, που όμως στα πλαίσια της Marca Espana, η κοινότητα των ρομά, ρομαντικοποιείται. Επί σκηνής, ο Ρομά είναι σεβαστός. Εκτός σκηνής, ένας Ρομά είναι απαράδεκτος και αόρατος.
...
σε έναν πιο σύγχρονο αστικό τρόπο ζωής. Αυτό συνίστανται κυρίως στην άνοδο της ασύγχρονης κοινωνικής ταξικής δομής και μια στρωματοποιημένη κουλτούρα, 
με ιδιόμορφα εθνοτικά χαρακτηριστικά, που αποτυπώνονται στην εμφάνιση του προαστιακού και υποπολιτισμικού περιβάλλοντος περιθωριοποίησης, που συνδέεται με τον ιδιαίτερο τρόπο ζωής,
...
τα δύο μουσικά στυλ θεωρούνται όχι μόνο ότι επηρεάστηκαν από διαφορετικές μουσικές παραδόσεις και πληθυσμούς που ξεριζώθηκαν από το αρχικό τους περιβάλλον, 
αλλά αποτέλεσε το απαύγασμα του κοινού κώδικα έκφρασης της ιδιόρρυθμης ιδιοσυγκρασίας των τάξεων από χαμηλά κοινωνικά επίπεδα στο αστικό περιβάλλον, 
...
Ωστόσο, η ιδεολογική ιδιαιτερότητα των δύο μουσικών ειδών, και οι προσπάθειες που έκαναν οι καλλιτέχνες και οι διανοούμενοι για να αξιοποιήσουν τα προηγουμένως περιθωριοποιημένα
μουσικά στυλ, που αποδίδονταν σε εγκληματίες, τον υπόκοσμο, τα πορνεία ή απλά εκπροσώπους διαφόρων στερεότυπων όπως των Τσιγγάνων ή των Τούρκων, αποτελούν, από τότε και ακόμη, πηγή έντασης και σύγκρουσης λόγω της κοινωνικοπολιτισμικής ασυμβατότητας της καταγωγής τους και αντίστοιχα της διαφορετικής αισθητικής που παρουσιάζουν.
